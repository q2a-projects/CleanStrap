...
class qa_html_theme extends qa_html_theme_base
{
    ...
    function logo()
    {
        ...
        $this->output('<div class="site-logo">', '<a class="navbar-brand" title="' . strip_tags($this->content['logo']) . '" href="/">
...
?>"/>
								<input type="submit"  value="Registrati" value="<?php
...
?>
    ...
    function main()
    {
        ...
        if ($this->cs_position_active('Header')) {
            $this->output('<div class="row header-position-c clearfix">');

            //$this->output('<h1 class="intro-title"> ' . qa_lang_html('cleanstrap/got_questions') . '</h1>');
            $this->output('<h1 class="intro-title"><img src="http://onequestion.anddos.org//qa-theme/CleanStarp/images/logo_big.png" /></h1><h5 id="powered">Powered by ANDDOS</h5><h2 id="tagline">Le tue domande su sesso, salute e famiglie</h2>');
